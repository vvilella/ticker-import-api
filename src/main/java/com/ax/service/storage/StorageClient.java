...
public class StorageClient {
	...
	public static Bucket getBucket(String bucketName) throws IOException, GeneralSecurityException {
		...
		// Fetch the full set of the bucket's properties (e.g. include the ACLs in the
		// response)
	...
	/**
	 * Download data to an object in a bucket.
	 *
	 * @param name       the name of the destination object.
	 * @param bucketName the name of the bucket to create the object in.
	 * @return
	 */
	public static void downloadFile(String bucketName, String name, Path destFilePath)
			throws IOException, GeneralSecurityException {
